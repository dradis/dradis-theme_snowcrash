...
;(function ( $, window, undefined ) {
  ...
  Plugin.prototype = {
    ...
    _buildToolbar: function() {
      ...
      button = $('<a class="btn-fullscreen icon-resize-full" href="javascript:void(null);"><span>&nbsp;</span></a>');
      ...
      // Help
      button = $('<a class="btn-help icon-question" href="javascript:void(null);"><span>&nbsp;</span></a>');
    ...
    _onBtnFullScreen: function() {
      ...
      if (this.options.fullscreen === false ) {
        ...
        // update button icon
        $btnFS.removeClass('icon-resize-full').addClass('icon-resize-small');
      ...
      else
      {
        ...
        // update button icon
        $btnFS.removeClass('icon-resize-small').addClass('icon-resize-full');
      }
    },
    _onBtnHelp: function() {
      var scope = this.options.wrap;
